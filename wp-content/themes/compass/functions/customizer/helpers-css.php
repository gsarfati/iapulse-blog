...
if ( ! class_exists( 'compass_CSS' ) ) :
    ...
    class compass_CSS {
        ...
        /**
         * The one instance of compass_CSS.
         *
         * @var   compass_CSS    The one instance for the singleton.
         */
        ...
        /**
         * Instantiate or return the one compass_CSS instance.
         *
         * @return compass_CSS
         */
        ...
        public function add( $data ) {
             ...
             * @param array    $data    The selectors and properties to add to the CSS.
             */
            $data  = apply_filters( 'compass_css_add', $data );
        ...
        private function parse_declarations( $declarations, $tab = '' ) {
             ...
             * routines are implemented when the developer calls `compass_get_css->add()`. Because every property value has
            ...
            foreach ( $declarations as $property => $value ) {
                 ...
                 */
                $output .= apply_filters( 'compass_parse_declaration', $parsed_value, $property, $value, $t, $n );
            }
             ...
             */
            return apply_filters( 'compass_css_parse_declarations', $output, $declarations, $tab );
        }
    }
endif;

if ( ! function_exists( 'compass_get_css' ) ) :
    /**
     * Return the one compass_CSS object.
     *
     * @return compass_CSS    The one compass_CSS object.
     */
    function compass_get_css() {
        return compass_CSS::instance();
    }
endif;

add_action( 'init', 'compass_get_css', 1 );