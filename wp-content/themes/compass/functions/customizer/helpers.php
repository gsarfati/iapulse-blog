...
function compass_sanitize_choice( $value, $setting ) {
    return $value;
}
 ...
 */
function compass_sanitize_text( $string ) {
    global $allowedtags;
     ...
     */
    apply_filters( 'compass_sanitize_text_allowed_tags', $expandedtags, $string );
