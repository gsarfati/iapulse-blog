    ...
    <h2>ZOOM Framework Update</h2>
        ...
        <?php if ($isUpdated) : ?>
            ...
            <div style="border: 1px solid #E6DB55;background-color: #FFFBCC;color: #424242;padding: 10px;margin-top: 20px;border-radius:4px;">
                ...
                <p><strong>Important:</strong> Backup your theme and modified files before updating.</p>
            ...
            <?php endif; ?>
        <?php else : ?>
            <p>&rarr; <strong>You are using latest framework version:</strong> <?php echo esc_html($localVersion); ?></p>
